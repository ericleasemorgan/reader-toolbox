...
setup(
	...
	install_requires=[ 'catalogue', 'click', 'datasette', 'matplotlib', 'nltk', 'tika', 'pandas', 'requests', 'pytextrank', 'scikit-learn', 'scipy', 'srsly', 'textacy', 'pytextrank', 'wordcloud', 'networkx', 'gensim', 'rdflib' ],
