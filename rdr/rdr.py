...
@click.option('-f', '--field', type=click.Choice( [ 'author', 'title', 'date', 'track', 'category', 'type', 'year', 'journal', 'topic', 'college', 'discipline', 'degree', 'pub_place' , 'region' ] ), help="field for pivoting" )
